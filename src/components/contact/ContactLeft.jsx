    ...
    <div className="w-full lgl:w-[35%] h-full bg-gradient-to-r from-[#1e2024] to-[#23272b] p-4 lgl:p-8 rounded-lg shadow-shadowOne flex flex-col gap-8 justify-center">
      ...
      <div data-aos="zoom-in" className="flex flex-col gap-4 ">
        <h3 className="text-3xl font-bold text-white">
          <span className="text-designColor">A</span>nand{" "}
          <span className="text-designColor">K</span>umar
        </h3>
        <p className="text-lg font-bold text-gray-400 hover:text-designColor group">
          Front-end Developer{" "}
          <span className="group-hover:text-gray-400 text-designColor">|</span>{" "}
          React Developer{" "}
          <span className="group-hover:text-gray-400 text-designColor">|</span>{" "}
          Angular Developer
        </p>
        ...
        <p className="text-base text-gray-400 flex items-center gap-2">
          Email:{" "}
          <span className="text-lightText">anandkumar101002@gmail.com</span>
        </p>
      </div>
      <div>
        <Media />
