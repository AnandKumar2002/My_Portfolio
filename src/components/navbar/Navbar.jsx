...
function Navbar() {
  ...
  return (
    <div className="w-full sticky top-0 z-50 bg-bodyColor h-20 mx-auto flex justify-between items-center font-titleFont border-b-[1px] border-b-gray-600 shadow-2xl shadow-black  lgl:px-14 px-4">
      <div className="px-5">
        <a href="https://leetcode.com/u/01AnandKumar/" target="_blank">
      ...
      <div>
        ...
        {showMenu && (
          <div
            data-aos="fade-right"
            className="w-[85%] h-screen overflow-scroll absolute top-0 left-0 bg-gray-900 p-4 scrollbar-hide z-50"
          >
