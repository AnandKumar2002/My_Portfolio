    ...
    <div className="flex flex-col gap-6 justify-between">
      <div>
        ...
        <div className="flex gap-4">
          <a href="https://www.linkedin.com/in/01anand-kumar/" target="_blank">
            <span className="bannerIcon">
              <FaLinkedinIn />
            </span>
          </a>
          <a href="https://github.com/anandkumar2002" target="_blank">
            <span className="bannerIcon">
              <FaGithub />
            </span>
          </a>
          ...
          <a href="mailto:anandkumar101002@gmail.com" target="_blank">
            <span className="bannerIcon">
              <SiGmail />
            </span>
          </a>
      ...
      <div className="flex gap-4">
        <a href={Anand_Kumar_Resume} target="_blank">
